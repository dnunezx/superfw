...
en_strings = [
  ...
  "MSG_TOOLS_RESET_FAVORITES": "Reset Favorites",
  "MSG_TOOLS_RESET_RECENT":    "Reset Recent",
  "MSG_Q_RESET_FAVORITES": "Reset Favorites? ROMs stay.",
  "MSG_Q_RESET_RECENT":    "Reset Recent? ROMs stay.",
